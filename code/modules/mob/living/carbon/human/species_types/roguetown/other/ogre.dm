...
/datum/species/ogre
	...
	id = "ogre"
	desc = "<b>Ogres</b><br>\
	Creatures born from the labors of Graggar, Ogres are his favored children in all creation. Massive in appetite and size, they are titans of the battlefield and maneaters who smash all who oppose their strength and take as they please from the world. Native to the windswept steppes of Gronn, they migrated across the world in search of food and riches as conquerors and mercenaries.<br>\
	<span style='color: #6a8cb7;text-shadow:-1px -1px 0 #000,1px -1px 0 #000,-1px 1px 0 #000,1px 1px 0 #000;'><b> +2 STR | +2 CON | +1 WIL |</span> <span style='color: #cc0f0f;text-shadow:-1px -1px 0 #000,1px -1px 0 #000,-1px 1px 0 #000,1px 1px 0 #000;'><b> -1 SPD | -3 INT</span></b></span> </br>\
	...
	inherent_traits = list(TRAIT_NOMOBSWAP, TRAIT_OGRE_STRENGTH)
	...
	dam_icon = 'icons/roguetown/mob/bodies/dam/ogre.dmi'
	...
	offset_features = list(
		...
		OFFSET_SHIRT = list(0,0), OFFSET_ARMOR = list(0,0), OFFSET_HANDS = list(0,0), OFFSET_UNDIES = list(0,0), OFFSET_BREASTS = list(0,4), \
		...
		OFFSET_SHIRT_F = list(0,0), OFFSET_ARMOR_F = list(0,0), OFFSET_UNDIES_F = list(0,-1), OFFSET_BREASTS_F = list(0,4)
	)
	race_bonus = list(STAT_STRENGTH = 2, STAT_CONSTITUTION = 2, STAT_WILLPOWER = 1, STAT_INTELLIGENCE = -3, STAT_SPEED = -1)
