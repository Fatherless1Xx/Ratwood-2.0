...
/datum/component/riding/proc/get_offsets(pass_index, mob/living/user = null) // list(dir = x, y, layer)
...
/datum/component/riding/cyborg/get_offsets(pass_index, mob/living/user = null) // list(dir = x, y, layer)
